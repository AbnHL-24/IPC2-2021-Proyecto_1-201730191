...
<html>
    <head>
        ...
        <title>MiMuebleria - Inicio de sesion</title>
    ...
    <body>
                ...
                <div class="col-xl-6">
                    ...
                    <form id="form-login" action="${pageContext.request.contextPath}/login" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="username" id="username" placeholder="Ingrese nombre de usuario" autofocus>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4>Ocurrieron los siguientes errores en la lectura del archivo:</h4>
        ...
        <script src="${pageContext.request.contextPath}/js/validationFiles/login.js"></script>
